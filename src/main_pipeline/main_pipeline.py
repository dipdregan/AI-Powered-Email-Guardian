...
class Pipeline:
    ...
    def start_model_evaluation(self, data_transformation_artifact, model_trainer_artifact, **kwargs):
        try:
            ...
            model_evaluation_artifact = model_evaluation.initiate_model_evaluation(**kwargs)
            return model_evaluation_artifact
        except Exception as e:
            raise e
        
    def start_model_pusher(self, data_transformation_artifact, model_evaluation_artifact, **kwargs):
        try:
            model_loader = ModelLoader(data_transformation_artifact=data_transformation_artifact,
                                       model_evaluation_artifact=model_evaluation_artifact)
            model_loader_artifact = model_loader.initiate_model_pusher(**kwargs)
    ...
    def initiate_pipeline(self):
        try:
            ...
            model_pusher_artifact = self.start_model_pusher(data_transformation_artifact, model_evaluation_artifact)
