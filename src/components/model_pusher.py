...
class ModelLoader:
    def __init__(self,
        ...
        self.bucket_name = 'hamspam22'
        self.s3_new_version = "New_version_model"
        self.s3_older_version = "Older_version_model"
    ...
    def accessing_path_s3(self):
        file_paths = []
        response = self.s3_client.list_objects_v2(Bucket=self.bucket_name, Prefix=self.s3_new_version + '/')
    ...
    def initiate_model_pusher(self):
        ...
        if not file_paths:
            logging.error("No models found in S3.")
            return
